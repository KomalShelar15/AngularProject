...
@Component({
    ...
    styleUrls:["./pform.component.html"]
...
export class PformComponent{
    ...
    addProduct(){
        ...
        this.pservice.addProduct(p).subscribe(result=>{this.parr=result;
    ...
    updateProduct(){
        let p=new Product(this.pid,this.pname,this.price);
        this.pservice.updateProduct(p).subscribe(result=>{this.parr=result;
                  this.myevent.emit(this.parr);
                  this.myevent1.emit(false);
        });
        this.pid=0;
